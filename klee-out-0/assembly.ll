...
entry:
  ...
  %1 = bitcast i32* %target_bg to i8*, !dbg !38
  call void @klee_make_symbolic(i8* %1, i64 4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0)), !dbg !39
  %2 = load i32, i32* %blood_glucose, align 4, !dbg !40
  %3 = load i32, i32* %target_bg, align 4, !dbg !41
  %call = call i32 @insulin(i32 %2, i32 %3), !dbg !42
  ret i32 %call, !dbg !43
}
...
!38 = !DILocation(line: 32, column: 21, scope: !29)
!39 = !DILocation(line: 32, column: 2, scope: !29)
!40 = !DILocation(line: 34, column: 17, scope: !29)
!41 = !DILocation(line: 34, column: 32, scope: !29)
!42 = !DILocation(line: 34, column: 9, scope: !29)
!43 = !DILocation(line: 34, column: 2, scope: !29)
